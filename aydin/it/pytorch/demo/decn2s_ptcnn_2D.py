...
from aydin.it.pytorch.it_ptcnn_deconv import PTCNNDeconvolution
...
def demo(image):
    ...
    it_denoise = PTCNNImageTranslator(
        max_epochs=1500, patience=512, learning_rate=0.01, normaliser_type='identity'
    )
    ...
    lr = LucyRichardsonDeconvolution(
        psf_kernel=psf_kernel, max_num_iterations=10, use_gpu=False
    )
