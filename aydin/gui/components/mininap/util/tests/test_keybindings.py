...
def test_components_to_key_combo():
    ...
    assert components_to_key_combo('2', ['Control', 'Shift']) == 'Control-Shift-2'
...
def test_normalize_key_combo():
    ...
    assert normalize_key_combo('Shift-Alt-Control-Meta-2') == 'Control-Alt-Shift-Meta-2'
