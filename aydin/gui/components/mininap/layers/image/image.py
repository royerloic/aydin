...
from ...util.misc import is_multichannel, calc_data_range, increment_unnamed_colormap
...
class Image(Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            visual, name=name, opacity=opacity, blending=blending, visible=visible
        )
    ...
    def colormap(self, colormap):
        ...
        if isinstance(colormap, str):
            ...
            name = increment_unnamed_colormap(name, list(self._colormaps.keys()))
    ...
    def _set_view_slice(self):
        ...
        indices[:-2] = np.clip(indices[:-2], 0, np.subtract(self.shape[:-2], 1))
